...
cfg.MODEL.BACKBONE.PROMPT_LAYERS = 8
...
# MODEL.TARGET_QUERY_PROMPTS
cfg.MODEL.TARGET_QUERY_PROMPTS = edict()
cfg.MODEL.TARGET_QUERY_PROMPTS.PROMPT_LAYERS = 8
cfg.MODEL.TARGET_QUERY_PROMPTS.NHEADS=8
cfg.MODEL.TARGET_QUERY_PROMPTS.DROPOUT = 0.1


# MODEL.TEXT
cfg.MODEL.TEXT_ENCODER = 'roberta-base'
cfg.MODEL.FREEZE_TEXT_ENCODER = True
cfg.MODEL.VLFUSION_LAYERS = 1


cfg.MODEL.BACKBONE.Z_SIZE = 128
cfg.MODEL.BACKBONE.X_SIZE = 256
#position encoding
...
cfg.TRAIN.QUERY_AUX_WEIGHT = 0.1
