...
def get_optimizer_scheduler(net, cfg):
    ...
    if train_cls:
        ...
        param_dicts = [
            {"params": [p for n, p in net.named_parameters() if "rgbl" in n and p.requires_grad]},
            {
                "params": [p for n, p in net.named_parameters() if "rgbl" not in n and p.requires_grad],
