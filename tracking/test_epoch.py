...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--tracker_name', type=str, default='AQTP', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default=cfg, help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='AQTP_hivitb_v1-'+str(num), help='Name of save file.')
...
def set_state(state, tracker_param):
    path = '/home-gxu/wwj22/AQTP-NL/experiments/AQTP/'+tracker_param+'.yaml'
...
if __name__ == '__main__':
    cfg = 'AQTP-ep150-256'  #改
    datasets = ['otb_lang', 'tnl2k_lang', 'lasot_lang', 'lasot_extension_subset_lang'] # 'otb_lang', 'tnl2k_lang', 'lasot_lang', 'lasot_extension_subset_lang'
